...
/**
 * Wraca do faktycznej poprzedniej strony w historii przeglądarki.
 * fallback — gdy nie ma historii (np. pierwsze wejście bezpośrednie na stronę).
 */
...
function applyAppearance() {
    var type = localStorage.getItem('appAppearance') || 'ios';
    if(type === 'android') {
